    ...
    return (
        <Box className="login" >
            ...
            <Grid container className='container'>
                <Grid item lg={3.7} className='right' sx={{ display: { xs: "none", lg: "flex" } }}>
                    <h1>
                        Vision Integration
                    </h1>
                    <p >
                    ...
                    <Image
                        src="/images/image.webp"  // Path to the image (in the "public" folder)
                ...
                <Grid item xs={12} lg={8} >
                    <Grid container className='inside-container'>
                        <Grid item xs={10} lg={5.5} className='left'>
                            ...
                            <p className='p-1'>
                                <Link to="/signup">هل لديك حساب ؟</Link>
                                {' '}
                                <Link to="/start">ابدأ</Link>
                            </p>
                            ...
                            <form >
                                ...
                                <p><Link>هل نسيت كلمة السر ؟ </Link></p>
                                <Box className="row">
                                ...
                                }} className='btn'>تسجيل الدخول</Button>
                            </form>
                        </Grid>
                    </Grid>
                </Grid>
